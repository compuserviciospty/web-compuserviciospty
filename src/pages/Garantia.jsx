...
function Garantia() {
    return (
        <div className="page-content">
            <Helmet>
                <title>Compuservicios PTY - Garantía</title>
                <meta name="description" content="Condiciones de garantía de equipos vendidos en Compuservicios PTY. Laptops, CPUs y accesorios." />
            </Helmet>

            <h1 className="main-title">
                Condiciones de Garantía de Equipos Vendidos en Compuservicios PTY
            </h1>
            ...
            {/* Sección 2 */}
            <section>
                <h2 className="section-subtitle">Garantía de Laptops</h2>
            ...
            {/* Sección 3 */}
            <section>
                <h2 className="section-subtitle">Garantía de CPUS</h2>
